...
Housing data collection came from web scraping on streeteasy.com mainly through `RSelenium` package. Similarly I gathered the Walk Score data through `rvest` package. Then I did the matching of rent and sale, also the combination of walk score and housing data through `dplyr`. Data cleaning and wrangling is accompanied all along every steps, which can be found in the R script in data_code folder. 
